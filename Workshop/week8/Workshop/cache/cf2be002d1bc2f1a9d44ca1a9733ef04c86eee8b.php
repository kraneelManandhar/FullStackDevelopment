...
<body>
    ...
    <div class="box">
        <h2>Test Results:</h2>
        <p><strong>Variable Test:</strong> Hello, <?php echo e($name); ?>!</p>
        <p><strong>Date Test:</strong> Today is <?php echo e(date("Y-m-d")); ?></p>
        <p><strong>Time Test:</strong> Current time: <?php echo e(date("H:i:s")); ?></p>
    ...
    <div class="box">
        ...
        <ul>
        <?php for($i = 1; $i <= 3; $i++): ?>
            <li>Item number <?php echo e($i); ?></li>
        <?php endfor; ?>
        </ul>
    </div>
...
</html><?php /**PATH C:\xampp\htdocs\week8\Workshop\views/welcome.blade.php ENDPATH**/ ?>